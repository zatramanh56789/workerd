...
http_archive(
    ...
    sha256 = "065d514f545d35b1fcee4a7a9f8bb2cdd32457a2d3fb765733697de172a6561e",
    type = "tar.bz2",
    urls = ["https://github.com/cloudflare/pyodide-build-scripts/releases/download/v4/pyodide-asm.tar.bz2"],
)
