...
http_archive(
    ...
    sha256 = "1b30043bbdb243368e77370c4188f57268a09a7f80d4f584478c9b6feb952d85",
    type = "tar.bz2",
    urls = ["https://github.com/cloudflare/pyodide-build-scripts/releases/download/v2/pyodide-asm.tar.bz2"],
)
